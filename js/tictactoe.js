...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
       //This variable retrieves the html element id that clicked.
       ...
       if(activePlayer === 'O'){
           ...
           disableClick();
           //This function wait 1 second before placing the image
           //and enabling click.
...
//This function makes our body element temporarily clickable.
...
function animateLineDrawing() {
   ...
   c.beginPath();
   //This method move us to a starting point for our line.
   c.moveTo(x1, y1);
   //This method indicates the end of our line.
   c.lineTo(x, y);
